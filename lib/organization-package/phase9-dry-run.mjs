...
const windowStub = {
  // Post-pilot baseline correction: `hovedordre` (main timesheet bucket) and
  // `hoofdordre` (the organization's primary active work order) are separate
  // fields, not spellings of one — see normalizeConfig() in public/motor.js.
  // This used to assign the latter to the former.
  PUNCHOUT_CONFIG: { lonnskoder: loadedRuntime.runtimeConfig.lonnskoder, kjoretoy: loadedRuntime.runtimeConfig.kjoretoy, sjaDefaults: {}, externalLinks: loadedRuntime.runtimeConfig.externalLinks, hovedordre: "HOVED", hoofdordre: loadedRuntime.runtimeConfig.hoofdordre },
