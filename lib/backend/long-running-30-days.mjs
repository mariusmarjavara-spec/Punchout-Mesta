...
const regRes = await fetch(BASE_URL + "/api/devices/register", { method: "POST", headers: { "Content-Type": "application/json", "Authorization": "Bearer " + ADMIN_TOKEN }, body: JSON.stringify({ deviceId }) });
...
sandbox.ADMIN_CONFIG.hovedordre = orgId;
...
const backendExports = await (await fetch(BASE_URL + "/api/export")).json();
