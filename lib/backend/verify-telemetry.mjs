...
// Operation Punchout Soft Launch, Phase B: emitTelemetry() used to stamp
// organizationId from ADMIN_CONFIG.hovedordre (the main ORDER number field,
// a confusion fixed this same session) — it now stamps from the real
// ADMIN_CONFIG.organizationId, set directly here.
