...
const getRes2 = await fetch(BASE_URL + "/api/telemetry?org=" + orgId);
...
console.log("dataSource:", oc.dataSource, "| telemetryEventCount:", oc.telemetryEventCount, "| dataAvailability.exportSuccess:", oc.dataAvailability.exportSuccess);
