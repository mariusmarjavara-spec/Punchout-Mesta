 ...
 * @property {string[]} [attachedRules] - Rule ids (lib/rules/types.mjs) this schema's fields/status can trigger; the rule LOGIC lives in the rule registry, never inlined here
