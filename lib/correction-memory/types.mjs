 ...
 * @property {number} [runtimeVersion]  - Phase 8 Del 7: which Runtime was active when this correction was made, so a replay can be run under the historical configuration the user actually saw, not today's
 *
