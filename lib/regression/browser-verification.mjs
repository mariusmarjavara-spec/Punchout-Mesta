 ...
 * first time ever — finding two real bugs in the process (a
 * @vercel/analytics 404 on every real page load, and device provisioning
 * silently never persisting the export secret/userId). This script
